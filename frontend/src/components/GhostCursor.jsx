...
/**
 * GhostCursor – fluid, smoky cursor trail effect using Three.js.
 *
 * Props:
 *   className, style, trailLength, inertia, grainIntensity,
 *   bloomStrength, bloomRadius, bloomThreshold, brightness,
 *   color, mixBlendMode, edgeIntensity, maxDevicePixelRatio,
 *   targetPixels, fadeDelayMs, fadeDurationMs, zIndex
 *
 * The parent container must have `position: relative` (or similar).
 */
